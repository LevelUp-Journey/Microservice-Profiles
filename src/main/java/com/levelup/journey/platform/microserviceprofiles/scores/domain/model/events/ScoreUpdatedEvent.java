...
public class ScoreUpdatedEvent {
    ...
    public ScoreUpdatedEvent(String userId, Integer newTotalPoints, Integer pointsEarned, String source, Long executionTimeMs, Long solutionTimeSeconds) {
        this.userId = userId;
        this.newTotalPoints = newTotalPoints;
        this.pointsEarned = pointsEarned;
        this.source = source;
        this.executionTimeMs = executionTimeMs != null ? executionTimeMs : 0L;
        this.solutionTimeSeconds = solutionTimeSeconds != null ? solutionTimeSeconds : 0L;
    ...
    public ScoreUpdatedEvent(String userId, Integer newTotalPoints, Integer pointsEarned, String source, Long executionTimeMs) {
        this(userId, newTotalPoints, pointsEarned, source, executionTimeMs, 0L);
    }

    // Backward compatibility constructor
    @Deprecated
    public ScoreUpdatedEvent(String userId, Integer newTotalPoints, Integer pointsEarned, String source) {
        this(userId, newTotalPoints, pointsEarned, source, 0L, 0L);
    }
}
